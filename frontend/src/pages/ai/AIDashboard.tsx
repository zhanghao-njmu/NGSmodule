        ...
        <Tabs activeKey={activeTab} onChange={setActiveTab} size="large">
                  ...
                  >
                    <Space direction="vertical" size="middle" style={{ width: '100%' }}>
                      <div className="feature-icon">
                        <BulbOutlined
                          style={{ fontSize: 48, color: DesignTokens.colors.warning.main }}
                        />
                      </div>
                      <div>
                        <Title level={4}>Parameter Recommendations</Title>
                        <Paragraph type="secondary">
                          AI-powered suggestions for optimal pipeline parameters based on your
                          data characteristics, similar successful runs, and best practices.
                        </Paragraph>
                      </div>
                ...
                <Col xs={24} md={12}>
                  ...
                  >
                    <Space direction="vertical" size="middle" style={{ width: '100%' }}>
                      <div className="feature-icon">
                        <ExperimentOutlined
                          style={{ fontSize: 48, color: DesignTokens.colors.primary.main }}
                        />
                      </div>
                      <div>
                        <Title level={4}>Auto Quality Control</Title>
                        <Paragraph type="secondary">
                          Automated quality assessment with intelligent scoring, issue detection,
                          and actionable recommendations for sample quality improvement.
                        </Paragraph>
                      </div>
                      <div className="feature-stats">
                        <Statistic
                ...
                <Col xs={24} md={12}>
                  ...
                  >
                    <Space direction="vertical" size="middle" style={{ width: '100%' }}>
                      <div className="feature-icon">
                        <WarningOutlined
                          style={{ fontSize: 48, color: DesignTokens.colors.error.main }}
                        />
                      </div>
                      <div>
                        <Title level={4}>Anomaly Detection</Title>
                        <Paragraph type="secondary">
                          Intelligent detection of quality drops, contamination, batch effects,
                          and outliers with automatic alerts and fix suggestions.
                        </Paragraph>
                      </div>
                      <div className="feature-stats">
                        <Statistic
                ...
                <Col xs={24} md={12}>
                  ...
                  >
                    <Space direction="vertical" size="middle" style={{ width: '100%' }}>
                      <div className="feature-icon">
                        <GroupOutlined
                          style={{ fontSize: 48, color: DesignTokens.colors.success.main }}
                        />
                      </div>
                      <div>
                        <Title level={4}>Smart Sample Grouping</Title>
                        <Paragraph type="secondary">
                          Automatic sample grouping based on metadata, QC metrics, and expression
                          patterns with suggested comparisons.
                        </Paragraph>
                      </div>
                      <div className="feature-stats">
                        <Statistic
                ...
                <Row gutter={[16, 16]}>
                  <Col xs={24} md={8}>
                    <Space direction="vertical">
                      <CheckCircleOutlined
                        style={{ fontSize: 24, color: DesignTokens.colors.success.main }}
                      />
                      <Title level={5}>Time Savings</Title>
                      <Paragraph type="secondary">
                        Save hours of manual parameter tuning and quality checking with automated
                        AI recommendations.
                      </Paragraph>
                    </Space>
                  </Col>
                  <Col xs={24} md={8}>
                    <Space direction="vertical">
                      ...
                      <Paragraph type="secondary">
                        Leverage best practices and historical data for {stats.accuracyRate}%
                  ...
                  <Col xs={24} md={8}>
                    <Space direction="vertical">
                      ...
                      <Paragraph type="secondary">
                        Catch issues before they become problems with real-time anomaly
          ...
          >
            <Empty
              ...
              description={
                <Space direction="vertical">
                  <Text>Parameter recommendations appear when creating or editing pipelines</Text>
...
/* navigate to pipelines */
          ...
          >
            <Empty
              ...
              description={
                <Space direction="vertical">
                  <Text>QC reports are generated automatically for each sample</Text>
                  <Button type="primary" onClick={() => {
/* navigate to samples */
}}>
                    View Samples
            ...
            tab={
              <Space>
                ...
                {stats.anomaliesDetected > 0 && (
                  <Tag color="red">{stats.anomaliesDetected}</Tag>
                )}
              </Space>
            }
            key="anomalies"
