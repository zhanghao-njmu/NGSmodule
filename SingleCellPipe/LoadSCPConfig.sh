...
complete_pattern="(FastqCheck passed)|(Analysis complete)|(fastp.json)|(Processing complete)|(Done Reports generation)|(Coverage by database)|(successfully)|(Terminated Succesfully)|(All done)|(Output created)"
