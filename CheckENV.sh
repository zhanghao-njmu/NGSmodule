...
env_packages["NGSmodule-Analysis"]="-c conda-forge -c bioconda r-base r-devtools r-biocmanager r-seurat r-signac r-future r-data.table bioconductor-rhdf5 bioconductor-hdf5array bioconductor-rsubread bioconductor-edger bioconductor-deseq2 bioconductor-rsamtools"
env_packages["NGSmodule-SCP"]="-c conda-forge -c bioconda fastqc fastq-screen velocyto.py r-base r-seurat r-signac r-future r-seuratdisk r-velocyto.r bioconductor-rtracklayer bioconductor-rsamtools bioconductor-genomicranges bioconductor-rhdf5 bioconductor-hdf5array"
