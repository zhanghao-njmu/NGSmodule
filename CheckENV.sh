...
env_packages["NGSmodule-Analysis"]="-c conda-forge -c bioconda 'r-base>=4.2.1' r-seurat r-signac r-future r-data.table bioconductor-rhdf5 bioconductor-hdf5array bioconductor-rsubread bioconductor-edger bioconductor-deseq2 bioconductor-rsamtools"
