...
error_pattern="(error)|(fatal)|(terrible)|(corrupt)|(unexpected)(interrupt)|(denied)|(refused)|(unrecognized)|(Failed to process)|(java.io.EOFException)|(no such file or directory)"
